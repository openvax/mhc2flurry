...
class Class2AffinityPredictor(object):
    """
    High-level interface for peptide/MHC I binding affinity prediction.

    This class manages low-level `Class2NeuralNetwork` instances, each of which
    wraps a single Keras network. The purpose of `Class2AffinityPredictor` is to
    ...
    def __init__(
        ...
        Parameters
        ----------
        allele_to_allele_specific_models : dict of string -> list of `Class2NeuralNetwork`
            Ensemble of single-allele models to use for each allele.

        class1_pan_allele_models : list of `Class2NeuralNetwork`
        ...
        manifest_df : `pandas.DataFrame`, optional
            ...
            Class2AffinityPredictor. Otherwise this dataframe will be generated
    ...
    def merge(cls, predictors):
        """
        Merge the ensembles of two or more `Class2AffinityPredictor` instances.
        ...
        Parameters
        ----------
        predictors : sequence of `Class2AffinityPredictor`

        Returns
        -------
        `Class2AffinityPredictor` instance
        ...
        return Class2AffinityPredictor(
    ...
    def merge_in_place(self, others):
        ...
        Parameters
        ----------
        others : list of Class2AffinityPredictor
    ...
    def save(self, models_dir, model_names_to_write=None, write_metadata=True):
        ...
        the configurations of each Class2NeuralNetwork, along with per-network
    ...
    def load(models_dir=None, max_models=None, optimization_level=None):
        ...
        max_models : int, optional
            Maximum number of `Class2NeuralNetwork` instances to load
        ...
        for (_, row) in manifest_df.iterrows():
            weights_filename = Class2AffinityPredictor.weights_path(
        ...
        result = Class2AffinityPredictor(
            allele_to_allele_specific_models=allele_to_allele_specific_models,
            class1_pan_allele_models=class1_pan_allele_models,
            allele_to_sequence=allele_to_sequence,
    ...
    def __repr__(self):
        ...
        return "<Class2AffinityPredictor %s>" % " ".join(pieces)
    ...
    def fit_allele_specific_predictors(
        ...
        The new predictors are saved in the Class2AffinityPredictor instance
        ...
        inequalities : list of string, each element one of ">", "<", or "="
            See `Class2NeuralNetwork.fit` for details.
        ...
        models_dir_for_save : string, optional
            If specified, the Class2AffinityPredictor is (incrementally) written
    ...
    def predict(
        ...
        model_kwargs : dict
            Additional keyword arguments to pass to Class2NeuralNetwork.predict
    ...
    def calibrate_percentile_ranks(
        ...
        model_kwargs : dict
            Additional low-level Class2NeuralNetwork.predict() kwargs.
    ...
    def model_select(
        ...
        Parameters
        ----------
        score_function : Class2AffinityPredictor -> float function
            Scoring function
        ...
        Returns
        -------
        Class2AffinityPredictor : predictor containing the selected models
        """
        ...
        new_predictor = Class2AffinityPredictor(
            allele_to_allele_specific_models,
            metadata_dataframes={
                "model_selection": df,
            })
